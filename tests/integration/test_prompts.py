...
class TestPromptTemplate:
    ...
    def test_init_basic(self):
        ...
        template = PromptTemplate(name="test_tool", template="Question: What is {param1}?")
    ...
    def test_init_with_metadata(self):
        ...
        template = PromptTemplate(name="test_tool", template="Question: {input}", metadata=metadata)
    ...
    def test_extract_placeholders_multiple(self):
        ...
        template = PromptTemplate(
            "test", "Drug: {Drug SMILES}, Target: {Target sequence}, Phase: {Trial phase}"
        )
    ...
    def test_extract_placeholders_duplicates(self):
        ...
        template = PromptTemplate(
            "test", "First {Drug SMILES}, second {Drug SMILES}, third {Other}"
        )
    ...
    def test_extract_placeholders_none(self):
        ...
        template = PromptTemplate("test", "This template has no placeholders")
    ...
    def test_required_inputs(self):
        ...
        template = PromptTemplate("test", "{Drug SMILES} and {Target sequence}")
    ...
    def test_format_success(self):
        ...
        template = PromptTemplate("test", "Drug: {Drug SMILES}, Target: {Target sequence}")

        result = template.format(**{"Drug SMILES": "CC(=O)O", "Target sequence": "MKTAYIAK"})
    ...
    def test_get_description_from_metadata(self):
        ...
        template = PromptTemplate(
            "test", "Question: {input}", metadata={"description": "Test description"}
        )
    ...
    def test_to_metadata(self):
        ...
        template = PromptTemplate(
            "test", "{Drug SMILES} and {Target sequence}", metadata={"category": "test"}
        )
    ...
    def test_str_representation(self):
        ...
        template = PromptTemplate(
            "test", "{Drug SMILES}", metadata={"description": "Test description"}
        )
    ...
    def test_repr_representation(self):
        ...
        template = PromptTemplate("test", "{Drug SMILES}", metadata={"category": "test"})
...
class TestPromptLoader:
    ...
    def test_init_custom(self):
        ...
        loader = PromptLoader(
            hf_repo="custom/repo", filename="custom.json", local_override=Path("test.json")
        )
    ...
    def test_load_from_local_simple_format(self, tmp_path):
        ...
        prompts_file.write_text(json.dumps({"test_tool": "Question: What is {Drug SMILES}?"}))
            ...
            json.dumps(
                {
                    ...
                    "rich": {"template": "Question: {input}", "metadata": {"key": "value"}},
                }
            )
        )
    ...
    def test_load_missing_template_field(self, tmp_path):
        ...
        prompts_file = tmp_path / "bad.json"
        prompts_file.write_text(json.dumps({"tool": {"metadata": {"key": "value"}}}))
    ...
    def test_reload(self, tmp_path):
        ...
        # Update file
        prompts_file.write_text(json.dumps({"tool1": "Updated: {input}", "tool2": "New: {input}"}))
    ...
    def test_all(self, tmp_path):
        """Test all() method."""
        prompts_file = tmp_path / "test.json"
        prompts_file.write_text(json.dumps({"tool1": "Q1", "tool2": "Q2"}))
    ...
    def test_filter_by_placeholders_all(self, tmp_path):
        ...
        loader = PromptLoader(local_override=prompts_file)
        filtered = loader.filter_by_placeholders(["Drug SMILES", "Target sequence"], match_all=True)
    ...
    def test_filter_by_placeholders_any(self, tmp_path):
        ...
        filtered = loader.filter_by_placeholders(
            ["Drug SMILES", "Target sequence"], match_all=False
        )
