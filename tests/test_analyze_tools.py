...
class TestCLIArguments:
    ...
    def test_no_arguments(self, mock_subsets, mock_analyze, mock_build_tools, 
                         mock_get_loader, mock_loader, mock_tools, capsys):
...
class TestFiltering:
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_placeholder_filter(self, mock_subsets, mock_analyze, mock_build_tools,
                                mock_get_loader, mock_loader, mock_tools, capsys):
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_placeholder_fuzzy_filter(self, mock_subsets, mock_analyze, mock_build_tools,
                                     mock_get_loader, mock_loader, mock_tools, capsys):
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_simple_filter(self, mock_subsets, mock_analyze, mock_build_tools,
                          mock_get_loader, mock_loader, mock_tools, capsys):
        """Test --simple filter."""
        mock_get_loader.return_value = mock_loader
        mock_build_tools.return_value = mock_tools
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_exclude_filter(self, mock_subsets, mock_analyze, mock_build_tools,
                           mock_get_loader, mock_loader, mock_tools, capsys):
        """Test --exclude filter."""
        mock_get_loader.return_value = mock_loader
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_combined_filters(self, mock_subsets, mock_analyze, mock_build_tools,
                             mock_get_loader, mock_loader, mock_tools, capsys):
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_placeholders_match_all(self, mock_subsets, mock_analyze, mock_build_tools,
                                    mock_get_loader, mock_loader, mock_tools, capsys):
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_placeholders_match_any(self, mock_subsets, mock_analyze, mock_build_tools,
                                   mock_get_loader, mock_loader, mock_tools, capsys):
...
class TestOutputFormats:
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_json_output(self, mock_subsets, mock_analyze, mock_build_tools,
                        mock_get_loader, mock_loader, mock_tools, capsys):
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_verbose_output(self, mock_subsets, mock_analyze, mock_build_tools,
                           mock_get_loader, mock_loader, mock_tools, capsys):
...
class TestIntegration:
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_realistic_workflow(self, mock_subsets, mock_analyze, mock_build_tools,
                                mock_get_loader, mock_loader, mock_tools, capsys):
    ...
    @patch("analyze_tools.analyze_tools")
    @patch("analyze_tools.suggest_tool_subsets")
    def test_statistics_display(self, mock_subsets, mock_analyze, mock_build_tools,
                               mock_get_loader, mock_loader, mock_tools, capsys):
