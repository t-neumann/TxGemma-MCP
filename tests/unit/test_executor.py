...
class TestExecuteToolCore:
    ...
    def test_execute_tool_strips_whitespace(
        self, mock_loader, mock_predict_model, mock_param_mapping
    ):
...
class TestExecuteToolValidation:
    ...
    def test_validates_inputs(
        self, mock_validate, mock_loader, mock_predict_model, mock_param_mapping
    ):
    ...
    @patch("txgemma.executor.validate_tool_call")
    def test_uses_validated_inputs(
        self, mock_validate, mock_loader, mock_predict_model, mock_param_mapping
    ):
...
class TestLogging:
    ...
    def test_logs_tool_execution(
        self, mock_logger, mock_loader, mock_predict_model, mock_param_mapping
    ):
