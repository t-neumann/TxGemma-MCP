...
from txgemma.prompts import get_loader, PromptTemplate
...
def get_placeholder_description(placeholder: str, usage_count: Optional[int] = None) -> str:
    """
...
def get_placeholder_pattern(placeholder: str) -> Optional[str]:
    """
...
def build_tool_from_template(
    ...
    placeholder_stats: Optional[Dict[str, int]] = None,
) -> Tool:
    """
...
def build_tools(
    *,
    ...
    filter_placeholders: Optional[List[str]] = None,
    match_all: bool = True,
    ...
    if filter_placeholder:
        templates = loader.filter_by_placeholder(
            filter_placeholder,
            exact=exact_match
        )
    elif filter_placeholders:
        templates = loader.filter_by_placeholders(
            filter_placeholders,
            match_all=match_all
        )
    else:
